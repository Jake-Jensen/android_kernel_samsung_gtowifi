...
$(KERNEL_VM_CONFIG): $(KERNEL_VM_OUT)
	...
	if [ ! -z "$(KERNEL_CONFIG_OVERRIDE)" ]; then \
		echo "kernel VM Overriding kernel config with '$(KERNEL_CONFIG_OVERRIDE)'"; \
...
$(KERNEL_CONFIG): $(KERNEL_OUT)
	...
	$(hide) if [ ! -z "$(KERNEL_CONFIG_OVERRIDE)" ]; then \
			echo "kernel Overriding kernel config with '$(KERNEL_CONFIG_OVERRIDE)'"; \
...
$(KERNEL_HEADERS_INSTALL): $(KERNEL_OUT)
	...
	$(hide) if [ ! -z "$(KERNEL_CONFIG_OVERRIDE)" ]; then \
			echo "HEADERS Overriding kernel config with '$(KERNEL_CONFIG_OVERRIDE)'"; \
			for CONFIG_OVERRIDE in $(KERNEL_CONFIG_OVERRIDE);do echo $$CONFIG_OVERRIDE >> $(KERNEL_OUT)/.config;done; \
			$(MAKE) -C $(TARGET_KERNEL_SOURCE) O=$(BUILD_ROOT_LOC)$(KERNEL_OUT) $(KERNEL_MAKE_ENV) ARCH=$(KERNEL_ARCH) CROSS_COMPILE=$(KERNEL_CROSS_COMPILE) $(real_cc) oldconfig; fi
